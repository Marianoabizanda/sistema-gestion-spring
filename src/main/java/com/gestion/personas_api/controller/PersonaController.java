...
public class PersonaController {
    ...
    public Persona crear(@RequestBody PersonaRequest request) {//@RequestBody es la clave: le dice a Spring “lo que venga en el body (JSON), conviértelo a un objeto Java”.
